...
class Base_date:  # класс для работы с бд
    def __init__(self, file):
        self.title = file
    def select(self, res, table, uslov="and", z=[], dr=[]):  # метод получения данных из бд
    ...
    def create(self):  # метод создания и заполнения тестового пользователя в бд
        ...
        con.commit()
        cur.execute(
            f"""INSERT INTO users(name, login, password, Registration_date) VALUES('Artem', '104_105', '65_114_116_101_109', '2020-10-31')""")
        cur.execute(
